-- Snapshot mensuel automatique des stats Instagram : le 1er du mois tôt le
-- matin, la fenêtre Meta 28 j couvre quasi exactement le mois écoulé → l'edge
-- stats-monthly-snapshot fige ces chiffres dans la ligne du mois précédent pour
-- tous les comptes Instagram connectés (sans jamais écraser une saisie).
-- Même plomberie que trigger_email_event (vault + extensions.http_post).
...
begin
  ...
  -- Le 1er de chaque mois à 04:30 UTC (tôt : la fenêtre 28 j colle au mois écoulé).
