...
import { LINKEDIN_PRINCIPLES_COMPACT, LINKEDIN_STORYTELLING_RULES, LINKEDIN_TEMPLATES, ANTI_SLOP, CHAIN_OF_THOUGHT, ANTI_BIAS, EDITORIAL_ANGLES_REFERENCE, PREGEN_INJECTION_RULES, EMBEDDED_EDUCATION } from "../_shared/copywriting-prompts.ts";
  ...
  try {
    ...
    if (action === "title") {
      ...
      const templateList = [
        ...
        { id: "storytelling_pro", label: "Storytelling pro", desc: "Raconter un vécu professionnel depuis le point de vue de la personne", objectif: "confiance" },
