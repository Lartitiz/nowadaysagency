...
// être réservé à l'owner de l'espace (ou à un compte admin), contrairement au
// mode brandingOnly qui reste ouvert à tout membre (déjà accessible par RLS
// sur la plupart de ces tables, voir commentaire dans use-reset-branding.ts).
//
