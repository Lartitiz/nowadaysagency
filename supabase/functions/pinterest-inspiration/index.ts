...
FORMAT DE RÉPONSE (JSON strict, rien d'autre) :
{
  ...
  "proposals": [
    ...
    const result = tryParseAiJson<any>(rawResponse, "pinterest-inspiration");
    if (result === null) {
      return new Response(
    ...
    await logUsage(user.id, "content", "pinterest_inspiration", usage.total_tokens, usage.model, filterWs);
