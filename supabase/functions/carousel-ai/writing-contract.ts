...
export const CAROUSEL_WRITING_VERSION = "fil-v5.1";
...
Relis enfin couverture, titres et corps comme un texte continu. Relie les passages avec la matière disponible ; ajouter « ensuite » ne répare pas un saut de raisonnement. Les nuances nécessaires restent présentes, et une note distincte explicitement demandée est conservée.
