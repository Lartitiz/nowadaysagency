...
Garde le cas de départ comme fil de l'analyse : explique comment les observations conduisent au point de vue puis, si demandé, à son application métier. Un conseil général découle de ce cas avec un lien explicite ; ne juxtapose pas actualité, opinion, fiche de conseils et présentation du métier en rubriques autonomes. N'impose aucun lien commercial. Les limites de la source qualifient les affirmations concernées au moment où elles apparaissent ; ne les efface pas pour fluidifier le récit et n'invente aucune mesure ou omission.
`;
