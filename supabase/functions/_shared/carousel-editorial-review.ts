...
export const CAROUSEL_REVIEW_VERSION = "contextual-v1";
...
COMPRÉHENSION DU SUJET : le brief actuel fait autorité pour CE contenu. Le branding donne le registre, jamais des faits manquants sur un produit ou un vécu. Supprime les affirmations non étayées (fabrication ou conception, anecdote, résultat, durée, disponibilité, rareté), sans inventer de remplacement. Une opinion, une image ou de l'humour n'ont pas besoin de devenir une description neutre.
...
Repère les mécanismes, quelle que soit leur formulation ou leur ponctuation : opposition de façade ; annonce de révélation sans découverte ; transition emphatique qui ne relie rien ; conclusion répétant avec gravité l'idée déjà expliquée ; métaphore décorative ; slogan de valeur interchangeable. Ces exemples ne sont pas une liste exhaustive. Les fins de paragraphes ET les transitions au milieu des slides méritent la même attention. Ne t'arrête pas après avoir trouvé un premier défaut.
