...
export const TOTAL_STEPS = 11; // 0=welcome, 1=prenom+activite, 2=produits/services+précision, 3=links+docs, 4=canaux_combined, 5=objectif, 6=blocage, 7=temps, 8-9=affinage, 10=diagnostic_loading, (11=diagnostic_view via step>TOTAL_STEPS)
