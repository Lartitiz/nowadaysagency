...
${p(`Tu as <strong>de quoi créer tes premiers contenus</strong> gratuitement. Pas de piège, pas d'engagement.`)}
...
export function creditsExhaustedEmail(vars?: TemplateVars): string {
  ...
  return wrap("Tu as fait le tour de ta version gratuite !", `
${greeting(prenom)}
${p(`Tu as utilisé toutes tes créations gratuites — et franchement, bravo. Ça veut dire que tu as testé, exploré, et commencé à poser les bases de ta com'. C'est déjà beaucoup. 💪`)}
...
<ul style="margin:0 0 16px;padding-left:20px;font-size:15px;color:#1A1A1A;line-height:1.8;">
<li>✨ <strong>Création illimitée</strong> — audits, contenus, coaching, sans compter</li>
...
<span style="font-size:15px;color:#1A1A1A;">✨ <strong>Création illimitée</strong></span>
...
export const EMAIL_TEMPLATES = {
  ...
  credits_exhausted: { fn: creditsExhaustedEmail, subject: "Tu as fait le tour de ta version gratuite !" },
