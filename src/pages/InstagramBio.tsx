...
type View = "audit" | "branding-check" | "generator" | "results" | "mixer" | "validated";


const BIO_STRUCTURES_LOOKUP: Record<string, string> = {
  directe: "La Directe",
  stratege: "La Stratège",
  engagee: "L'Engagée",
  prouveuse: "La Prouveuse",
  storytelleuse: "La Storytelleuse",
  convertisseuse: "La Convertisseuse",
};
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <main className="mx-auto max-w-3xl px-6 py-8 max-md:px-4">
              ...
              {brandingFilled >= 2 ? (
                <>
                  ...
                  <div className="flex flex-wrap gap-3 pt-2">
                    <Button className="rounded-pill gap-2" onClick={() => setView("generator")}>
        ...
        {/* ═══════════════════════════════════════
           VIEW: GENERATOR (structure + differentiation + CTA)
           ═══════════════════════════════════════ */}
        {view === "generator" && (
          <BioGeneratorView
            bioStructure={bioStructure}
            setBioStructure={setBioStructure}
            diffAngle={diffAngle}
            setDiffAngle={setDiffAngle}
            diffText={diffText}
        ...
        {view === "results" && (
          <div className="space-y-6 animate-fade-in">
            ...
            <div className="flex flex-wrap gap-3">
              ...
              <Button variant="ghost" className="rounded-pill" onClick={() => setView("generator")}>
