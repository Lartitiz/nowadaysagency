...
export default function SalesPageOptimizer() {
  ...
  const handleAnalyze = async () => {
    ...
    try {
      ...
      // Persiste l'analyse : alimente la bannière "récent" (lue au montage) et permet
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <footer className="text-center py-6 text-xs text-muted-foreground">
        Créé avec L'Assistant Com' par <a href="https://nowadays-assistant.fr" className="text-primary underline">Nowadays Agency</a>
      </footer>
    </div>
  );
}
