...
function GuidedTimeline({ completion, navigate, onShowSynthesis }: { completion: BrandingCompletion; navigate: (path: string) => void; onShowSynthesis: () => void }) {
  return (
