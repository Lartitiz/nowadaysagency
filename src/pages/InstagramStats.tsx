    ...
    try {
      ...
      for (let i = 1; i < rows.length; i++) {
        ...
        const payload: any = {
          ...
          reach: safeNum(r[3]), stories_coverage: safeNum(r[4]),
          views: safeNum(r[5]), profile_visits: safeNum(r[6]),
          website_clicks: safeNum(r[7]), interactions: safeNum(r[8]),
          accounts_engaged: safeNum(r[9]), followers_engaged: safeNum(r[10]),
          followers: safeNum(r[11]), followers_gained: safeNum(r[12]),
          followers_lost: safeNum(r[13]),
          email_signups: safeNum(r[16]), newsletter_subscribers: safeNum(r[17]),
          website_visitors: safeNum(r[18]),
          traffic_pinterest: safeNum(r[19]), traffic_instagram: safeNum(r[20]),
          ga4_users: safeNum(r[21]), traffic_search: safeNum(r[22]),
          traffic_social: safeNum(r[23]), ad_budget: safeNum(r[24]),
          page_views_plan: safeNum(r[25]), page_views_academy: safeNum(r[26]),
          page_views_agency: safeNum(r[27]), discovery_calls: safeNum(r[28]),
          clients_signed: safeNum(r[29]), revenue: safeNum(r[30]),
        };
