...
const DEMO_FICHE_DATA: Record<Section, Record<string, string>> = {
  story: {
    step_1_raw: "J'ai fait une école de com', puis bossé en agence 3 ans. La photo c'était un hobby au départ.",
    step_2_location: "Paris, puis Lyon après le burnout.",
    step_3_action: "J'ai pris mon appareil un dimanche soir de crise, je suis sortie shooter des portraits de passantes.",
    step_4_thoughts: "Ce soir-là j'ai su que je voulais faire ça de ma vie.",
    step_5_emotions: "Soulagement, excitation, peur aussi. Mais une certitude : je ne retournerai pas en agence.",
    step_6_full_story: "",
  ...
  persona: {
    step_1_frustrations: "Ne se trouve pas photogénique. Photos corporate sans âme. Repousse toujours la séance photo depuis des mois.",
    step_2_transformation: "Elle rêverait d'avoir des images qui lui ressemblent vraiment. Naturelles, lumineuses, où elle a l'air confiante sans forcer. Et qu'elle puisse les utiliser partout.",
    step_3a_objections: "\"C'est trop cher pour des photos\", \"Je ferai ça quand j'aurai plus de clients\"",
    step_3b_cliches: "Elle pense que les photos pro c'est forcément des poses rigides en studio avec un fond blanc. Que c'est réservé aux grandes entreprises.",
    step_4_beautiful: "Lumière naturelle, tons chauds, portraits authentiques, ambiance cosy studio",
    step_4_inspiring: "Visages sans retouche, sourires vrais, femmes qui assument",
    step_4_repulsive: "Photos corporate froides, retouche excessive, poses forcées, fonds blancs cliniques",
    step_4_feeling: "Confiance, chaleur, authenticité, fierté",
    step_5_actions: "",
    pitch_short: "",
    pitch_medium: "",
    pitch_long: "",
  ...
  tone_style: {
    voice_description: "Comme une copine photographe : franche, bienveillante, inspirante. Je tutoie toujours, j'utilise des emojis, je raconte des anecdotes de séances. Jamais de formules pompeuses.",
    combat_cause: "Que les femmes arrêtent de se cacher derrière un logo ou des photos de stock.",
    combat_fights: "Le mythe du 'pas photogénique'. Les photos retouchées à outrance. Le body shaming déguisé en conseils posture.",
    combat_alternative: "Des photos authentiques, chaleureuses, qui montrent la vraie personne derrière le business.",
    combat_refusals: "Les retouches excessives, les shootings à la chaîne, les tarifs à 50€ qui dévalorisent tout le monde.",
    tone_register: "tu",
    tone_level: "amie",
    tone_style: "oral",
    tone_humor: "auto-derision",
    tone_engagement: "nuancee",
    key_expressions: "\"Franchement, t'es canon sur cette photo\", \"Le truc c'est que...\", \"T'es prête ?\"",
    things_to_avoid: "Le jargon technique photo, le ton corporate froid, \"N'hésitez pas à me contacter\", \"prestations haut de gamme\", \"shooting photo\"",
    target_verbatims: "",
  },
  content_strategy: {
    step_1_hidden_facets: "Mon rapport au corps et à la confiance, mes doutes d'indépendante, ma vie de photographe au quotidien.",
    facet_1: "Mon rapport au corps et à la confiance en soi",
    facet_2: "Ma vie de photographe indépendante",
    facet_3: "Les coulisses de mes séances (le coaching posture)",
